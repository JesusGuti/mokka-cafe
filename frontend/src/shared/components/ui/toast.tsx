...
function ToastProvider({ ...props }: Readonly<ToastPrimitive.Provider.Props>) {
  return <ToastPrimitive.Provider {...props} />;
}

function ToastPortal({ ...props }: Readonly<ToastPrimitive.Portal.Props>) {
...
function ToastViewport({
  className,
  ...props
}: Readonly<ToastPrimitive.Viewport.Props>) {
  return (
...
function Toast({ className, ...props }: Readonly<ToastPrimitive.Root.Props>) {
  return (
    <ToastPrimitive.Root
      data-slot="toast"
      className={cn(
...
function ToastContent({
  className,
  ...props
}: Readonly<ToastPrimitive.Content.Props>) {
  return (
...
function ToastTitle({
  className,
  ...props
}: Readonly<ToastPrimitive.Title.Props>) {
  return (
...
function ToastDescription({
  className,
  ...props
}: Readonly<ToastPrimitive.Description.Props>) {
  return (
...
function ToastAction({
  ...
  ...props
}: Readonly<ToastPrimitive.Action.Props>) {
  return (
...
function ToastClose({
  ...
  ...props
}: Readonly<ToastPrimitive.Close.Props>) {
  return (
...
function Toaster({
  ...
  toastManager = toast,
  ...props
}: Readonly<ToastPrimitive.Provider.Props>) {
  return (
